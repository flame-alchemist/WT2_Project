...
<body>
  ...
  <center>
  <div id="boxx">
  <p>This Privacy Policy governs the manner in which Cell City collects, uses, maintains and discloses information collected from users (each, a "User") of the http://www.cellcity.com website ("Site").</p>
  </div>
  ...
  <p>Cell City may collect and use Users personal information for the following purposes:</p>
  <ul>
    <li>
  ...
  <p id = "update">This document was last updated on November 16, 2017  </p>
  <center>
    <footer>
